...
while True:
    ...
    if opcion == 1:
        ...
        codigo = input('Codigo: ')
        edad = int(input('Edad: '))
        if registrar_aventureros(aventureros, codigo, nombre, edad):
        ...
        if registro_ptj(aventureros, codigo, puntaje):
        ...
        if mod_puntaje(aventureros, codigo, sesion, nuevo_puntaje):
            print('Cambio realizado exitos')
            print(aventureros)
        else:
            print('Sesión o aventurero incorrecto. Reintete.')
